    ...
    columns = [
        ...
        ui.table_column(
            ...
            cell_type=ui.tag_table_cell_type(
                name="tags",
                tags=[
                    ui.tag(label=status.name, color=status.color)
        ...
        items=[
            ui.inline(
                items=[
                    ...
                    ui.button(
                        name="dcp_parse_action", label="Refresh", value=str(dcp.id)
                    ),
                    ui.button(
        ...
        items["pkl_infos_" + pkl["FileName"]] = (
            ...
            + [
                ui.expander(
                    name="expander",
                    label="Raw PKL Data",
                    items=[dict_to_searchable_table(infos)],
                )
            ]
        )
        ...
        for reellist in infos["ReelList"]:
            reels += [
                ...
                ui.expander(
                    ...
                    label=type,
                    items=[ui.text(dict_to_table(flatten_dict(asset)))],
                )
...
def assetmap_infos(metadata):
    ...
    for assetmap in metadata.get("assetmap_list", []):
        ...
        assets = [
            (asset["Id"], asset["ChunkList"]["Chunk"]["Path"])
