...
from h2o_wave import Q, app, data, on, ui
...
def get_luminance(r: float, g: float, b: float) -> float:
    return (
        to_grayscale(r) * 0.2126 + to_grayscale(g) * 0.7152 + to_grayscale(b) * 0.0722
    )
...
def update_contrast_check(color1: str, color2: str, q: Q, min_contrast=4.5):
    ...
    if contrast < min_contrast:
        ...
        message_bar.text = (
            message_bar_mobile.text
        ) = f"Improve contrast between **{color1}** and **{color2}**."
    else:
        message_bar.type = message_bar_mobile.type = "success"
        message_bar.text = (
            message_bar_mobile.text
        ) = f"Contrast between **{color1}** and **{color2}** is great!"
...
mobile_items = [
    ...
    ui.inline(
        ...
        items=[
            ui.persona(
                title="John Doe", subtitle="Data Scientist", size="s", image=image
            ),
    ...
    ui.combobox(
        name="combobox", label="Combobox", choices=["Choice 1", "Choice 2", "Choice 3"]
    ),
        ...
        items=[
            ui.table(
                ...
                columns=[
                    ...
                    ui.table_column(
                        name="age", label="Age", sortable=True, max_width="80px"
                    ),
                    ui.table_column(
                        name="progress",
                        label="Progress",
    ...
    if not q.client.initialized:
        ...
        q.page["meta"] = ui.meta_card(
            ...
            layouts=[
                ui.layout(
                    breakpoint="xs",
                    zones=[ui.zone("mobile_content"), ui.zone("footer")],
                ),
                ui.layout(
                    breakpoint="817px",
                    zones=[
        ...
        q.client.color_items = [
            ...
            ui.message_bar(
                name="text_card",
                type="success",
                text="Contrast between **text** and **card** is great!",
            ),
            ui.message_bar(
                name="card_primary",
                type="success",
            ...
            ui.message_bar(
                name="text_page",
                type="success",
                text="Contrast between **text** and **page** is great!",
            ),
            ui.message_bar(
                name="page_primary",
                type="success",
        ...
        q.page["footer"] = ui.footer_card(
            box="footer", caption="Made with 💛 by H2O Wave Team."
        )
        q.client.themes = [
            ui.theme(
                name="custom",
